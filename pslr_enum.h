...
PK_API pslr_color_space_t pslr_get_color_space( char *str );
PK_API const char *pslr_get_color_space_str( pslr_color_space_t value );

PK_API pslr_af_mode_t pslr_get_af_mode( char *str );
PK_API const char *pslr_get_af_mode_str( pslr_af_mode_t value );

PK_API pslr_ae_metering_t pslr_get_ae_metering( char *str );
PK_API const char *pslr_get_ae_metering_str( pslr_ae_metering_t value );

PK_API pslr_flash_mode_t pslr_get_flash_mode( char *str );
PK_API const char *pslr_get_flash_mode_str( pslr_flash_mode_t value );

PK_API pslr_drive_mode_t pslr_get_drive_mode( char *str );
PK_API const char *pslr_get_drive_mode_str( pslr_drive_mode_t value );

PK_API pslr_af_point_sel_t pslr_get_af_point_sel( char *str );
PK_API const char *pslr_get_af_point_sel_str( pslr_af_point_sel_t value );

PK_API char *pslr_get_af11_point_str( uint32_t value );

PK_API pslr_jpeg_image_tone_t pslr_get_jpeg_image_tone( char *str );
PK_API const char *pslr_get_jpeg_image_tone_str( pslr_jpeg_image_tone_t value );

PK_API pslr_white_balance_mode_t pslr_get_white_balance_mode( char *str );
PK_API const char *pslr_get_white_balance_mode_str( pslr_white_balance_mode_t value );

/* pslr_custom_ev_steps_t get_pslr_custom_ev_steps( char *str ); */
PK_API const char *pslr_get_custom_ev_steps_str( pslr_custom_ev_steps_t value );

PK_API const char *pslr_get_custom_sensitivity_steps_str( pslr_custom_sensitivity_steps_t value );

PK_API const char *pslr_get_image_format_str( pslr_image_format_t value );

PK_API const char *pslr_get_raw_format_str( pslr_raw_format_t value );

PK_API const char *pslr_get_scene_mode_str( pslr_scene_mode_t value );
