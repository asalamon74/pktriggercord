...
ipslr_model_info_t camera_models[] = {
    ...
    { 0x13092, "K-1",         false, true,  true,  true,  456,  3, {36, 22, 12, 2}, 9, 8000, 100, 204800, 100, 204800, PSLR_JPEG_IMAGE_TONE_FLAT, true,  33, ipslr_status_parse_k1, k1_setting_defs, sizeof(k1_setting_defs)/sizeof(k1_setting_defs[0])  },
