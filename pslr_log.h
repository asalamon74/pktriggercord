...
PK_API void pslr_set_verbosity(pslr_verbosity_t verbosity);
PK_API pslr_verbosity_t pslr_get_verbosity();

PK_API bool pslr_verbosity_enabled(pslr_verbosity_t level);

//TODO : offer a write_log_callback equivalent so a caller can fully configure what happends when pslr_write_log is called ?
PK_API void pslr_write_log(pslr_verbosity_t level, const char* message, ...);
